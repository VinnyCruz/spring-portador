...
public record CardHolderModel(
    ...
    public CardHolderModel(UUID clientId, UUID creditAnalysisId, Status status, BigDecimal creditLimit,
                           BankAccountModel bankAccount) {
    ...
    public CardHolderModel approveCardHolder(CardHolderModel cardHolderModel) {
